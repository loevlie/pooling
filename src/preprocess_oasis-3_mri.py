...
# python ../src/preprocess_oasis-3_mri.py --condition='AND' --nifti_dir='/cluster/tufts/hugheslab/datasets/OASIS-3_MRI' --numpy_dir='/cluster/tufts/hugheslab/datasets/OASIS-3_MRI_numpy' --scan_types 'T1w' 'T2w' --start=0 --stop=1620
