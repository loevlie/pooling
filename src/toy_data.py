...
# python ../src/toy_data.py --alpha=0.0 --batch_size=64 --criterion='ERM' --delta=1.0 --deltaS=3 --epochs=1000 --experiments_directory='/cluster/tufts/hugheslab/eharve06/pooling/experiments/toy_data' --lr=0.01 --model_name='test' --N_train=800 --N_test=100 --N_val=100 --pooling='max' --save --seed=42 --use_pos_embedding --weight_decay=0.0
